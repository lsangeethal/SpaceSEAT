...
fill(shadowColor)
  ...
  translate(20,20)
  rotate(boxAngle)
  rect(500, 200, 154, 154);
  boxAngle -= radians(1)
  pop()

  //part02
  push()
  translate(width/4*6,height/4*4)
  rotate(part02Angle);
  beginShape();
  vertex(225, part02Angle);
  bezierVertex(234, 554, 252, 558, 276, 562);
  bezierVertex(288, 563, 315, 562, 324, 560);
  bezierVertex(374, 541, 337, 535, 335, 487);
  bezierVertex(336, 454, 340, part02Angle, part02Angle, 431);
  bezierVertex(part02Angle, 404, 395, 376, 398, 356);
  bezierVertex(385, 343, 361, 330, 320, 318);
  bezierVertex(281, 314, 164, 335, 140, 337);
  bezierVertex(117, 342, part02Angle, part02Angle);
  endShape();
part02Angle = part02Angle + 4;
pop()
